...
const Dashboard = () => {
  ...
  return (
    <Section crosses id="dashboard">
      <div className="relative flex flex-col items-center justify-center min-h-screen p-8 mt-16 overflow-hidden bg-n-8/60">
        ...
        <div className="flex flex-row items-start justify-between gap-10 px-10 py-10">
          {/* Leva kolona - 2/3 širine */}
          ...
          <div className=" w-1/3 h-[690px] p-4 border border-purple-600 rounded-lg shadow-md bg-opacity-30">
            <h2 className="mb-4 text-xl font-semibold">Kreirani nalozi</h2>
            <p className="text-gray-500">
              Ovde možete napraviti account za vase dete, i pomocu qr koda da ga
              logujete na drugi racunar preko koga ce pristupiti kursu.
            </p>
            <div className="mt-20 ">
            ...
            <div className="flex justify-center">
              <button
                className="p-3 border border-purple-600 rounded-md mt-15 bg-n-8/90"
              ...
              {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
                  <div className="bg-n-8/90 rounded-lg shadow-xl p-6 w-[90%] max-w-md border border-purple-600">
